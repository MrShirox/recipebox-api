    ...
    public void run(String... args) {
        ...
        repository.saveAll(Arrays.asList(
            ...
            recipe("Bœuf Bourguignon", "Beef Bourguignon",
                ...
                "https://upload.wikimedia.org/wikipedia/commons/thumb/7/72/Boeuf_bourguignon.jpg/320px-Boeuf_bourguignon.jpg",
                "3h", "Moyen", 4,
            ...
            recipe("Quiche Lorraine", "Quiche Lorraine",
                ...
                "https://upload.wikimedia.org/wikipedia/commons/thumb/3/35/Quiche_Lorraine.jpg/320px-Quiche_Lorraine.jpg",
                "45min", "Facile", 6,
            ...
            recipe("Ratatouille", "Ratatouille",
                "Plat principal", "Main course", "diner",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Ratatouille_2.jpg/320px-Ratatouille_2.jpg",
                "1h", "Facile", 4,
            ...
            recipe("Gratin Dauphinois", "Potato Gratin",
                ...
                "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Gratin_Dauphinois.jpg/320px-Gratin_Dauphinois.jpg",
                "1h30", "Facile", 4,
            ...
            recipe("Crêpes Bretonnes", "Breton Crepes",
                ...
                "https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/Cr%C3%AApe_salad%C3%A9.jpg/320px-Cr%C3%AApe_salad%C3%A9.jpg",
                "30min", "Facile", 4,
            ...
            recipe("Soupe à l'Oignon", "French Onion Soup",
                "Entrée", "Starter", "dejeuner",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Onion_soup.jpg/320px-Onion_soup.jpg",
                "1h", "Facile", 4,
            ...
            recipe("Tarte Tatin", "Tarte Tatin",
                "Dessert", "Dessert", "dessert",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/3/thirty/TarteTatin.jpg/320px-TarteTatin.jpg",
                "1h", "Moyen", 6,
            ...
            recipe("Poulet Rôti", "Roast Chicken",
                "Plat principal", "Main course", "diner",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Roasted_chicken.jpg/320px-Roasted_chicken.jpg",
                "1h30", "Facile", 4,
            ...
            recipe("Moules Marinières", "Mussels Marinière",
                "Plat principal", "Main course", "diner",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Moules-frites.jpg/320px-Moules-frites.jpg",
                "30min", "Facile", 4,
            ...
            recipe("Crème Brûlée", "Crème Brûlée",
                "Dessert", "Dessert", "dessert",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Creme_brulee.jpg/320px-Creme_brulee.jpg",
                "1h", "Moyen", 4,
            ...
            recipe("Blanquette de Veau", "Veal Blanquette",
                "Plat principal", "Main course", "diner",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Blanquette_de_veau.jpg/320px-Blanquette_de_veau.jpg",
                "2h", "Moyen", 4,
            ...
            recipe("Salade Niçoise", "Niçoise Salad",
                "Entrée", "Starter", "dejeuner",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Salade_nicoise.jpg/320px-Salade_nicoise.jpg",
                "20min", "Facile", 4,
            ...
            recipe("Cassoulet", "Cassoulet",
                "Plat principal", "Main course", "diner",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Cassoulet.jpg/320px-Cassoulet.jpg",
                "3h", "Difficile", 6,
            ...
            recipe("Soufflé au Fromage", "Cheese Soufflé",
                "Entrée", "Starter", "dejeuner",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/Cheese_souffl%C3%A9_%281%29.jpg/320px-Cheese_souffl%C3%A9_%281%29.jpg",
                "45min", "Difficile", 4,
                "Préchauffer le four à 200°C. Préparer une béchamel avec beurre, farine et lait. Hors du feu, ajouter les jaunes d'œufs et le fromage râpé. Monter les blancs en neige ferme. Incorporer délicatement au mélange. Verser dans des moules beurrés. Cuire 20 minutes sans ouvrir le four.",
                "Preheat oven to 200°C. Make a béchamel with butter, flour and milk. Off heat, add egg yolks and grated cheese. Whip egg whites to stiff peaks. Fold gently into mixture. Pour into buttered moulds. Bake 20 minutes without opening oven.",
                fr("Emmental râpé", "Beurre", "Farine", "Lait", "Œufs", "Sel", "Poivre", "Muscade"),
                en("Grated emmental", "Butter", "Flour", "Milk", "Eggs", "Salt", "Pepper", "Nutmeg"),
                m("150g", "50g", "50g", "30cl", "4", "q.s.", "q.s.", "1 pincée"),
                tags("vegetarien", "sans-porc")),

            recipe("Pot-au-Feu", "Pot-au-Feu",
                "Plat principal", "Main course", "diner",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d8/Pot-au-feu.jpg/320px-Pot-au-feu.jpg",
                "3h30", "Facile", 6,
            ...
            recipe("Mousse au Chocolat", "Chocolate Mousse",
                "Dessert", "Dessert", "dessert",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Chocolate_mousse.jpg/320px-Chocolate_mousse.jpg",
                "20min", "Facile", 6,
            ...
            recipe("Coq au Vin", "Coq au Vin",
                "Plat principal", "Main course", "diner",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Coq_au_vin.jpg/320px-Coq_au_vin.jpg",
                "2h", "Moyen", 4,
            ...
            recipe("Tarte aux Pommes", "Apple Tart",
                "Dessert", "Dessert", "dessert",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a1/Apple_tart.jpg/320px-Apple_tart.jpg",
                "1h", "Facile", 8,
            ...
            recipe("Bouillabaisse", "Bouillabaisse",
                "Plat principal", "Main course", "diner",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/Bouillabaisse.jpg/320px-Bouillabaisse.jpg",
                "2h", "Difficile", 6,
                "Faire revenir l'oignon, l'ail, le fenouil et les tomates dans l'huile d'olive. Ajouter le safran et le bouquet garni. Mouiller avec l'eau et le vin blanc. Cuire 30 minutes. Passer au tamis. Ajouter les poissons selon leur temps de cuisson. Servir avec des croûtons et de la rouille.",
                "Sauté onion, garlic, fennel and tomatoes in olive oil. Add saffron and bouquet garni. Add water and white wine. Cook 30 minutes. Strain. Add fish according to cooking time. Serve with croutons and rouille.",
                fr("Poissons variés", "Tomates", "Oignon", "Fenouil", "Ail", "Safran", "Vin blanc", "Huile d'olive", "Bouquet garni"),
                en("Various fish", "Tomatoes", "Onion", "Fennel", "Garlic", "Saffron", "White wine", "Olive oil", "Bouquet garni"),
                m("1.5kg", "3", "1", "1", "4 gousses", "1 pincée", "20cl", "4 c.s.", "1"),
                tags("sans-gluten", "sans-porc", "fruits-de-mer")),

            recipe("Pain Perdu", "French Toast",
                "Petit-déjeuner", "Breakfast", "petit-dejeuner",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/French_toast_with_strawberries.jpg/320px-French_toast_with_strawberries.jpg",
                "15min", "Facile", 4,
            ...
            recipe("Croissants", "Croissants",
                "Petit-déjeuner", "Breakfast", "petit-dejeuner",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Croissant_DSC04727.jpg/320px-Croissant_DSC04727.jpg",
                "3h", "Difficile", 8,
            ...
            recipe("Salade César", "Caesar Salad",
                "Entrée", "Starter", "dejeuner",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d9/Caesar_salad_%281%29.jpg/320px-Caesar_salad_%281%29.jpg",
                "20min", "Facile", 4,
                "Préparer la sauce en mélangeant mayonnaise, parmesan, ail, jus de citron et sauce Worcester. Couper la salade romaine. Faire dorer les croûtons dans l'huile d'olive. Mélanger la salade avec la sauce. Ajouter les croûtons et les copeaux de parmesan. Optionnel: ajouter du poulet grillé.",
                "Make dressing by mixing mayonnaise, parmesan, garlic, lemon juice and Worcester sauce. Cut romaine lettuce. Brown croutons in olive oil. Toss salad with dressing. Add croutons and parmesan shavings. Optional: add grilled chicken.",
                fr("Salade romaine", "Parmesan", "Croûtons", "Mayonnaise", "Ail", "Citron", "Sauce Worcester"),
                en("Romaine lettuce", "Parmesan", "Croutons", "Mayonnaise", "Garlic", "Lemon", "Worcester sauce"),
                m("1", "80g", "100g", "4 c.s.", "1 gousse", "1/2", "1 c.c."),
                tags("sans-porc")),

            recipe("Tarte Flambée", "Tarte Flambée",
                "Plat principal", "Main course", "diner",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/7/72/Tarte_flamb%C3%A9e.jpg/320px-Tarte_flamb%C3%A9e.jpg",
                "30min", "Facile", 4,
                "Préchauffer le four à 250°C. Étaler la pâte fine sur une plaque. Mélanger le fromage blanc et la crème fraîche, étaler sur la pâte. Répartir les oignons émincés et les lardons. Saler, poivrer. Cuire 12 minutes au four très chaud.",
                "Preheat oven to 250°C. Roll thin dough on a baking sheet. Mix fromage blanc and cream, spread over dough. Distribute sliced onions and lardons. Season. Bake 12 minutes in very hot oven.",
                fr("Pâte à pain", "Fromage blanc", "Crème fraîche", "Oignons", "Lardons", "Sel", "Poivre"),
                en("Bread dough", "Fromage blanc", "Cream", "Onions", "Lardons", "Salt", "Pepper"),
                m("300g", "200g", "10cl", "2", "150g", "q.s.", "q.s."),
                tags()),

            recipe("Œufs en Meurette", "Eggs in Red Wine Sauce",
                "Entrée", "Starter", "dejeuner",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Oeufs_en_meurette.jpg/320px-Oeufs_en_meurette.jpg",
                "45min", "Moyen", 4,
                "Faire réduire le vin rouge avec les échalotes, le bouquet garni et le lard. Filtrer. Monter la sauce au beurre. Pocher les œufs dans de l'eau vinaigrée. Griller les tranches de pain. Dresser les œufs pochés sur le pain, napper de sauce meurette et garnir de lardons.",
                "Reduce red wine with shallots, bouquet garni and bacon. Strain. Finish sauce with butter. Poach eggs in vinegar water. Toast bread slices. Plate poached eggs on toast, coat with meurette sauce and garnish with lardons.",
                fr("Œufs", "Vin rouge", "Lardons", "Échalotes", "Champignons", "Pain", "Beurre", "Bouquet garni"),
                en("Eggs", "Red wine", "Lardons", "Shallots", "Mushrooms", "Bread", "Butter", "Bouquet garni"),
                m("8", "50cl", "150g", "3", "100g", "4 tranches", "50g", "1"),
                tags("sans-gluten-possible")),

            recipe("Clafoutis aux Cerises", "Cherry Clafoutis",
                "Dessert", "Dessert", "dessert",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Clafoutis.jpg/320px-Clafoutis.jpg",
                "1h", "Facile", 6,
